 ...
 */
@Entity
@Table(name = "ZT_MC_BAS_EMAIL")
public class McBasEmail implements Serializable {
	/**
	 ...
	 */
	private static final long serialVersionUID = 2014120318591265638L;
	...
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_ZT_MC_BAS_EMAIL", allocationSize = 1)
