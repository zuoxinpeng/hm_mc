 ...
 */
@Entity
@Table(name = "ZT_MC_BAS_MESSAGE")
public class McBasMessage implements Serializable {
	/**
	...
	/**
	 * 获取 短信接收号码多个电话可按照”,”分隔, 类型String 默认值:""
	 */
	...
	/**
	 * 获取 需要延迟发送的时间，不传为立即发送短信, 类型Date 默认值:new Date()
	 */
	@DateTimeFormat(pattern = "yyyy-MM-dd hh:mm:ss")
	...
	/**
	 * 获取 组ID（网站、ivalue、比酷）, 类型long 默认值:0
	 */
	private String grpId;

	/**
	 * 获取 用户ID, 类型long 默认值:0
	 */
	private String mId;

	/**
	 * 获取 发送人ID, 类型long 默认值:0
	 */
	private String sId;

	/**
	 * 获取 任务类型(1.周期性任务，2.一次性任务), 类型long 默认值:(long)2
	 */
	...
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_ZT_MC_BAS_MESSAGE", allocationSize = 1)
	 ...
	 * 获取 短信接收号码多个电话可按照”,”分隔, 类型String 默认值:""
	 * 
	 * @return 短信接收号码多个电话可按照”,”分隔, 类型String 默认值:""
	 */
	...
	/**
	 * 设置 短信接收号码多个电话可按照”,”分隔, 类型String 默认值:""
	 * 
	 * @param sReceiver
	 *            短信接收号码多个电话可按照”,”分隔, 类型String 默认值:""
	 */
	 ...
	 * 获取 需要延迟发送的时间，不传为立即发送短信, 类型Date 默认值:new Date()
	 * 
	 * @return 需要延迟发送的时间，不传为立即发送短信, 类型Date 默认值:new Date()
	 */
	@Temporal(TemporalType.TIMESTAMP)
	...
	/**
	 * 设置 需要延迟发送的时间，不传为立即发送短信, 类型Date 默认值:new Date()
	 * 
	 * @param sSendTime
	 *            需要延迟发送的时间，不传为立即发送短信, 类型Date 默认值:new Date()
	 */
	 ...
	 * 获取 组ID（网站、ivalue、比酷）, 类型long 默认值:0
	 * 
	 * @return 组ID（网站、ivalue、比酷）, 类型long 默认值:0
	 */
	@Column(name = "GRP_ID")
	...
	/**
	 * 设置 组ID（网站、ivalue、比酷）, 类型String 默认值:0
	 * 
	 * @param sGrpId
	 *            组ID（网站、ivalue、比酷）, 类型String 默认值:0
	 */
	...
	/**
	 * 获取 用户ID, 类型String 默认值:0
	 * 
	 * @return 用户ID, 类型String 默认值:0
	 */
	@Column(name = "M_ID")
	...
	/**
	 * 获取 发送人ID, 类型String 默认值:0
	 * 
	 * @return 发送人ID, 类型String 默认值:0
	 */
	@Column(name = "S_ID")
	...
	/**
	 * 设置 发送人ID, 类型String 默认值:0
	 * 
	 * @param sSId
	 *            发送人ID, 类型String 默认值:0
	 */
	...
	/**
	 * 获取 任务类型(1.周期性任务，2.一次性任务), 类型String 默认值:(String)2
	 * 
	 * @return 任务类型(1.周期性任务，2.一次性任务), 类型String 默认值:(String)2
	 */
	...
	/**
	 * 设置 任务类型(1.周期性任务，2.一次性任务), 类型String 默认值:(String)2
	 * 
	 * @param sTaskType
	 *            任务类型(1.周期性任务，2.一次性任务), 类型String 默认值:(String)2
	 */
