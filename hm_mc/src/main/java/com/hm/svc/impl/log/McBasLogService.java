...
@Service
@Transactional
public class McBasLogService extends HibernateServiceBase<McBasLog> implements IMcBasLogService {
	@Autowired
	...
	public PageList<McBasLog> findByContentPriority(java.lang.String content, // 日志内容
		...
		return theDao.findByContentPriority(content, priority, order, orderDir, pageNum, pageSize);
	}
