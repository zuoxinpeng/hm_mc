 ...
 * 
 */
public interface IMcBasEmailFailService extends HibernateService<McBasEmailFail> {
	 ...
	 * @return 数据列表的强类型实体类
	 */
	public abstract List<McBasEmailFail> findByTime(java.util.Date sendTimeStart, // 发送开始时间
	 ...
	 * @return 数据列表的强类型实体类
	 */
	public abstract PageList<McBasEmailFail> findByReceiver(java.lang.String receiver, // 邮件接收人
			String order, // 排序字段
			String orderDir, // 排序顺序
			int pageNum, // 当前分页的页数
			int pageSize// 每页条数
