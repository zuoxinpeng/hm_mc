 ...
 */
@Entity
@Table(name = "ZT_MC_BAS_MESSAGE_FAIL")
public class McBasMessageFail implements Serializable {
	/**
	 ...
	 */
	private static final long serialVersionUID = 2014112817153992322L;
	...
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_ZT_MC_BAS_MESSAGE_FAIL", allocationSize = 1)
