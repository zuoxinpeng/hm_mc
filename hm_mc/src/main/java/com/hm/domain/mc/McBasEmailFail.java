...
public class McBasEmailFail implements Serializable {
	...
	public McBasEmailFail(String receiver, String subject, String content, String key, long status, String grpId, String taskType, String errorMessage, Date sendTime, Date createTime, Date updateTime) {
