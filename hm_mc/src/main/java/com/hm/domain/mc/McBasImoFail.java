 ...
 */
@Entity
@Table(name = "ZT_MC_BAS_IMO_FAIL")
public class McBasImoFail implements Serializable {
	/**
	 ...
	 */
	private static final long serialVersionUID = 2015010515433072742L;
	...
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_ZT_MC_BAS_IMO_FAIL", allocationSize = 1)
