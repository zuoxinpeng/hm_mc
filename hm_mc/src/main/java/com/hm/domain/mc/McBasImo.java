...
public class McBasImo implements Serializable {
	...
	public McBasImo(String receiver, String receiverUid, String subject, String content, String key, long status, String grpId, Date sendTime, Date createTime, Date updateTime) {
		super();
