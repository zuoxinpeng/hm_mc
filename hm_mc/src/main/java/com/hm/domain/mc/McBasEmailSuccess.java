 ...
 */
@Entity
@Table(name = "ZT_MC_BAS_EMAIL_SUCCESS")
public class McBasEmailSuccess implements Serializable {
	/**
	 ...
	 */
	private static final long serialVersionUID = 2014120318592118740L;

	public McBasEmailSuccess() {
	}

	public McBasEmailSuccess(String receiver, String subject, String content, String key, long status, String grpId, String taskType, Date sendTime, Date createTime, Date updateTime) {
	...
	@SequenceGenerator(name = "generator", sequenceName = "SEQ_ZT_MC_BAS_EMAIL_SUCCESS", allocationSize = 1)
